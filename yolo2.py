...
class YOLO(object):
    ...
    def generate2(self):
        ...
        if self.eager:
            self.input_image_shape = Input([2, ], batch_size=1)
            inputs = [*self.yolo_model2.output, self.input_image_shape]
            outputs = Lambda(yolo_eval, output_shape=(1,), name='yolo_eval',
            ...
            self.boxes2, self.scores2, self.classes2 = yolo_eval(self.yolo_model2.output, self.anchors,
    ...
    def detect_image(self, image):
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            label = '{} {:.2f}'.format(predicted_class, self.score)
    ...
    def detect_image2(self, image, image2):
        ...
        for i, c in list(enumerate(out_classes2)):
            ...
            # 画框框, {:.2f}score2
            label = '{} {:.2f}'.format(predicted_class, self.score2)
            # label = '{}'.format(predicted_class)
